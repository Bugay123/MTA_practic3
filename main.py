...
def discriminant_analysis(A, B, X_new):
    """Лінійний дискримінантний аналіз для двох класів."""
    # середні вектори
...
def print_results(task_name, A, B, X_new):
    ...
    print(task_name)
    print(df)
    print(f"w = {np.round(w, 4)}, c = {np.round(c, 4)}")
...
print_results("Завдання 1", A1, B1, X1)
...
print_results("Завдання 2", A2, B2, X2)
...
print_results("Завдання 3", A3, B3, X3)
...
print_results("Завдання 4", A4, B4, X4)
...
print_results("Завдання 5", A5, B5, X5)
